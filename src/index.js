...
// const myProfile = ["Enna", 27];

// const message3 = `名前は${myProfile[0]}です。年齢は${myProfile[1]}です。`;
// console.log(message3);

// const [name, age] = myProfile;
// const message4 = `名前は${name}です。年齢は${age}です。はい。`;
...
// console.log(arr8);
// arr8[0] = 100;
// console.log(arr4); // 参照渡しされてしまっているのでarr4にも影響している

/**
 * mapやfilterを使った配列の処理
 */
// const nameArr = ["田中", "山田", "Enna"];
